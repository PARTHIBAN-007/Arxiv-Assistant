...
def generate_daily_report(**context):
    """Generates a daily report of the ingestion pipeline results"""
    ...
    hybrid_stats = ti.xcom_pull(task_ids ="index_paper_hybrid",key="hybrid_index_stats") or {}
    ...
    report = {
        ...
        "indexing_statistics": {
            ...
            "chunks_processed": hybrid_stats.get("papers_stored",0),
    ...
    try:
        ...
        if opensearch_client.health_check():
            try:
                ...
                index_stats  = stats_response["indices"][opensearch_client]["total"]
